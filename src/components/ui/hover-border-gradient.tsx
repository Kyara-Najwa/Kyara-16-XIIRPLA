  ...
  return (
    <Tag
      ...
      className={cn(
        ...
        transparent ? "bg-transparent hover:bg-transparent" : "bg-black/20 hover:bg-black/10 dark:bg-white/20",
        containerClassName
      )}
      {...props}
    >
      ...
      <motion.div
        className={cn(
          "flex-none -inset-1 overflow-visible absolute z-0 rounded-[inherit]"
        )}
        style={{
          filter: "blur(6px)",
          position: "absolute",
